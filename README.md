...
- **DeepSeek API & Model Selection:** รองรับโมเดล **`deepseek-flash`** / **`deepseek-v4-flash`** (V4 Flash ประหยัด Token สูงและเร็วเป็นพิเศษ), `deepseek-chat`, `deepseek-v4-pro`, `deepseek-reasoner` พร้อมช่องกรอกชื่อโมเดลเองได้อิสระและปุ่มซิงค์จาก API
